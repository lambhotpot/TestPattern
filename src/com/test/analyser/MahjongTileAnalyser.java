...
import com.test.experiment.OpenCVUtil;
...
public class MahjongTileAnalyser {
    //default value 14
    private int numberOfTiles = 14;

    public MahjongTileAnalyser(int numberOfTiles) {
...
//        MatOfDMatch good = new MatOfDMatch();
    ...
    private void analyseColor(Mat tile, MahjongTileAnalyseResult result) {
        ...
        result.setRedPercentage(red_percent);
        ...
        result.setBlackPercentage(black_percent);
        ...
        result.setBlueGreenPercentage(blue_percent+green_percent);
